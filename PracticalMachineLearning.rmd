...
First, Read the training **pml-training.csv** and testing **pml-testing.csv** data files. Then remove all variables with more than 20% of missing values.Finally, remove the first seven variables that represents ID variables and some technical information about the measurements. These variables are irelevant for the prediction. Do this for both training and testing data set.
...
```
These answers were submited to the website for grading and all answers were correct.